...
public interface UserRepository extends R2dbcRepository<UserEntity, String> {
        ...
        Flux<UserEntity> update(UUID id, String name, int age, String profileImage);
        ...
        Mono<Void> save(UUID id, String name, int age, List<String> products,String profileImage,List<String> connections);
